...
pack_mid = '<div class="tweak-info"><input type="checkbox" name="tweak"><img src="https://raw.githubusercontent.com/BEComTweaks/crafting-tweaks/main/relloctopackicon" style="width:82px; height:82px;" alt="pack_name"><br><label id="tweak" class="tweak-title">pack_name</label><div class="tweak-description">pack_description</div></div>'
...
if args.build:
    ...
    if args.use_relative_location:
        html= html.replace("https://raw.githubusercontent.com/BEComTweaks/crafting-tweaks/main/","../")
    # Update files

...
with open(f"{cdir()}/credits.md","r") as credits:
    html_end = f'</div><div class="download-container"><div class="file-download"><input type="text" id="fileNameInput" placeholder="Enter Pack name"><br><select name="mev" id="mev"><option value="1.21.0">1.21</option><option value="1.20.0">1.20</option><option value="1.19.0">1.19</option><option value="1.18.0">1.18</option><option value="1.17.0">1.17</option><option value="1.16.0">1.16</option></select></div><div class="zipinputcontainer"><input type="file" id="zipInput"/></div><button class="download-selected-button" onclick="downloadSelectedTweaks()">Download Selected Tweaks</button><div id="selected-tweaks"><div class="tweak-list-pack">Select some packs and see them appear here!</div></div></div><script src="app.js"></script></div></body><footer class="footer-container"><div class="half-dark"><div class="credits-footer">{str(markdown(credits.read()))}<p><a href="https://github.com/BEComTweaks/crafting-tweaks">GitHub</a></p></div></div></footer></html>'

html = '<!DOCTYPE html><html lang="en"><head><meta content="Bedrock Edition Community Tweaks Crafting Tweaks" name="author"><meta content="Crafting Tweak selector. Unofficially updated by BEComTweaks on GitHub" name="description"><meta charset="utf-8"><meta content="width=device-width, initial-scale=1.0" name="viewport"><title>Crafting Tweaks</title><style>@import url("https://becomtweaks.github.io/resource-packs/theme.css");</style><link href="images/icon.png" rel="icon" type="image/x-icon"></meta></meta></head><body><br><div id="background-container"></div><script src="bg.js"></script><div class="half-dark"><div class="image-container"><img alt="Crafting Tweaks" id="title" src="images/title.png"></div><ul class="large-nav"><li><a class="nav-link" href="https://becomtweaks.github.io">Home</a></li><a class="nav-link" href="https://becomtweaks.github.io/docs">Docs</a></li><li style="float:right"><a class="nav-link" href="https://becomtweaks.github.io/crafting-tweaks">Crafting Tweaks</a></li><li style="float:right"><a class="nav-link" href="https://becomtweaks.github.io/behaviour-packs">Behaviour Packs</a></li><li style="float:right"><a class="nav-link" href="https://becomtweaks.github.io/resource-packs">Resource Packs</a></li></ul><ul class="small-nav"><li><a class="nav-link" href="https://becomtweaks.github.io">Home</a></li><li style="float:right"><a class="nav-link" href="https://becomtweaks.github.io/crafting-tweaks">CTs</a></li><li style="float:right"><a class="nav-link" href="https://becomtweaks.github.io/behaviour-packs">BPs</a></li><li style="float:right"><a class="nav-link" href="https://becomtweaks.github.io/resource-packs">RPs</a></li></ul><div class="container"><!-- Categories -->'
stats = [0, 0]
